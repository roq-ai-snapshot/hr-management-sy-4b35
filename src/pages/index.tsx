  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="HR Management System: Streamlining Your Employee Data, Payroll, Time Tracking, Vacations, and Performance Evaluations in One Central Place"
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1517048676732-d65bc937f952?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxIUiUyMG1hbmFnZW1lbnR8ZW58MHx8fHwxNjk1MDEyNTE4fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`HR Management System: Streamlining Your Employee Data, Payroll, Time Tracking, Vacations, and Performance Evaluations in One Central Place`}
            </Text>
            <Box
