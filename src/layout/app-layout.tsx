...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Payrolls', path: '/payrolls', entity: 'payroll', service: AccessServiceEnum.PROJECT, icon: FiBox },
    {
    ...
    { name: 'Vacations', path: '/vacations', entity: 'vacation', service: AccessServiceEnum.PROJECT, icon: FiBox },
